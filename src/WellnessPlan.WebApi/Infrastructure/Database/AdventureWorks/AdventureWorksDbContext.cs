...
using WellnessPlan.WebApi.Infrastructure.Database.AdventureWorks.Entities;

namespace WellnessPlan.WebApi.Infrastructure.Database.AdventureWorks;
...
public partial class AdventureWorksDbContext : DbContext
{
    ...
    {
        // Example: Add custom configurations or conventions here
